...
category regarded as an $\infty$-category;
 \end{itemize}
 We closely followed the Referee's suggestion here. Moreover we added the definition of additive $\infty$-category along the lines suggested by the Referee and generalized the results in Subsection \S 5.2, showing that they hold under the milder assumption that $\mathcal{A}$ is additive (they had been stated for an abelian $\mathcal{A}$ in the first version of the manuscript).
 \begin{itemize}
...
A few lines have been added in the proof to make the argument hopefully clearer.
 ...
 \end{itemize}
 The whole Section 8 has now been reworked in a less colloquial statement/proof format. The statement of theorem 8.2 has been divided into a list of items so to make it hopefully less clumsy, and a more detailed proof has been written.
